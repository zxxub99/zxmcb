...
packages:
  ...
  '@leancloud/adapter-types@3.0.0':
    resolution: {integrity: sha512-/1l2PWJ6pXizHphBorMN7B0d2YjmxZJf1s+bitvLALt7wBid5qbGpHqGGKE/yRdNlCKwl9FbXG1x5wUFZfQwHQ==}

  '@leancloud/adapter-types@5.0.0':
    resolution: {integrity: sha512-psnPaa4ONaA6X9y9xsjLmJXH+2spySH/YQUz59S0cZUTWVbZaUFwLQyHkv8OzZFixKqs+eV3xnWl7nUxCCCIeg==}

  '@leancloud/adapter-utils@1.2.2':
    resolution: {integrity: sha512-B/bZM6WGN+sxMdZJeTWLAN/Gin00LX0E/M0MoygZhtrgCfCZSz47wgziOq5Fvl6yPifyvYBGaobydhyr7vxjxg==}

  '@leancloud/adapters-superagent@1.4.3':
    resolution: {integrity: sha512-zWfYEFUXahcZH+RgaRCgf/YCWdPr0svztXdLazrn22pCStGEu0qdt2rUV9dqiw9gMh3zdkHUt6ZxlmxQyO7uXw==}

  '@leancloud/platform-adapters-browser@1.5.3':
    resolution: {integrity: sha512-60atgNek/mdOEMyawYfCClllezS4grO8JY3a83zv2ZDJ0h58cLobsNK8FSkQHn9q8zLbCpeT0drB426g/pEhTw==}

  '@leancloud/platform-adapters-node@1.6.0':
    resolution: {integrity: sha512-CHvD1nSYOuS+obxGy4u7KstqfN7PM1NG8jCx3LED/8nGshJM11PfzCeocGkLULUaiLg/N/1cGvh4AKX8NmAo9A==}

  '@leancloud/platform-adapters-weapp@1.6.3':
    resolution: {integrity: sha512-adUCskxrCZ6aT8q9/s+JWXla1QIVKLAg571OP7VQeDvRqSYAUeqxLquQAmO0oiUQKsPDB5dDtYJHYvicJQK3IQ==}
  ...
  antd-mobile@5.42.3:
    resolution: {integrity: sha512-HLykA0Cr2am7dgEch/TRUnr4GHgTOM59rA9CVjgBJVVJ8dk2w8uUBz//Bji19sRH2leiUObWY7KQZpsWF+WQeg==}
    peerDependencies:
      react: ^16.8.0 || ^17.0.0 || ^18.0.0 || ^19.0.0
      react-dom: ^16.8.0 || ^17.0.0 || ^18.0.0 || ^19.0.0
  ...
  ascli@1.0.1:
    resolution: {integrity: sha512-JGQaNxpaCJz9Bd1JvVaFIHuWn9S+l3xhN17R0V/vmUDiGE0QngNMXhjlqpwqV+91plWz9Fg+Lt28Lj7p5vjs8A==}
  ...
  javascript-state-machine@2.4.0:
    resolution: {integrity: sha512-N5ebPfbgUPBQgu+Q3km/EAxFdG7sS9b+upP3917F/xvH+QES55ba9TfayJJqUQ1OdEuHqwqdadiyqYfalucBvw==}
  ...
  leancloud-realtime-plugin-live-query@1.2.0:
    resolution: {integrity: sha512-eJooIH8/FyUoozr3Eeby2DpDnmX39m1bfxfxlYPuojkio+i/DLwPD+aTHnRDH6QXJcT6tNTt85RcxVR/Txg98Q==}
    peerDependencies:
      leancloud-realtime: ^3.5.0 || ^4.0.0-beta.2 || ^5.0.0-alpha.2

  leancloud-realtime@5.0.0-rc.8:
    resolution: {integrity: sha512-H54ZPJnsR9oXM8fRqeT0foAIdtV9tqS9b+DQgzAIg1Okn0CBnJXSbJg5c4yHZNCtmX4lxZ1LudEspytW0V/AyQ==}

  leancloud-storage@4.15.2:
    resolution: {integrity: sha512-zvlfeG2aq25lFZ+2pvo0KoMf3jDuR0ThzLivCj5Yv3yhZf2i/BL5fypW+0IqRh6YSFkJ731iHHfq7FIPhxdHpw==}
  ...
  protobufjs@5.0.3:
    resolution: {integrity: sha512-55Kcx1MhPZX0zTbVosMQEO5R6/rikNXd9b6RQK4KSPcrSIIwoXTtebIczUrXlwaSrbz4x8XUVThGPob1n8I4QA==}
    engines: {node: '>=0.8'}
    hasBin: true
...
snapshots:
  ...
  antd-mobile@5.42.3(react-dom@18.3.1(react@18.3.1))(react@18.3.1):
    dependencies:
      '@floating-ui/dom': 1.7.6
      '@rc-component/mini-decimal': 1.1.3
      '@react-spring/web': 9.6.1(react-dom@18.3.1(react@18.3.1))(react@18.3.1)
